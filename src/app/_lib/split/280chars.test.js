...
test(t => {
  t.deepEqual(split(double('Short tweet.')), [double('Short tweet.')])
  const url =
...
test(t => {
  t.deepEqual(
    split(
      double("It took me half a year to release @date_fns v1.0.0. I was anxious and insecure and spend time procrastinating on unimportant tiny details. After a successful release, I realized how stupid I was and promised myself to never repeat the mistake. It's been alright until I decided to finally release v2.0.0... 8 months ago. I mean, yeah, v2.0.0 is coming really soon.")
    ),
    [
      double('It took me half a year to release @date_fns v1.0.0. I was anxious and insecure and spend time procrastinating on unimportant tiny details.'),
      double('After a successful release, I realized how stupid I was and promised myself to never repeat the mistake.'),
      double("It's been alright until I decided to finally release v2.0.0... 8 months ago. I mean, yeah, v2.0.0 is coming really soon.")
    ]
  )
})
...
test(t => {
  ...
  t.deepEqual(
    split(
      double('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla tristique nunc quis blandit ultricies. Nullam ante risus,[...]vehicula at arcu eleifend, tempus condimentum lectus.')
    ),
    [
      double('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla tristique nunc quis blandit ultricies. Nullam ante risus,'),
      double('vehicula at arcu eleifend, tempus condimentum lectus.')
    ]
  )
  ...
  t.deepEqual(
    ...
    [
      double('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla tristique nunc quis blandit'),
      double('ultricies. Nullam ante risus, vehicula at arcu eleifend tempus condimentum lectus.')
    ]
  )
  
  t.deepEqual(
    split(
      double('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla tristique nunc quis blandit ultricies. Nullam ante risus, vehicula at[...]arcu.')
    ),
    [
      double('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla tristique nunc quis blandit ultricies. Nullam ante risus, vehicula at'),
      double('arcu.')
    ]
  )
  ...
  t.deepEqual(
    ...
    [
      double('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla tristique nunc quis blandit ultricies. Nullam'),
      double('ante risus, vehicula at.')
    ]
  )
})
...
test(t => {
  t.deepEqual(
    split(
      double('Lorem ipsum dolor sit amet, consectetur adipiscing elitx nulla tristique nunc quis blandit ultriciesx nullam ante risus, vehicula at arcu eleifend, tempus condimentum lectus.')
    ),
    [
      double('Lorem ipsum dolor sit amet, consectetur adipiscing elitx nulla tristique nunc quis blandit ultriciesx nullam ante risus, vehicula at arcu…'),
      double('…eleifend, tempus condimentum lectus.')
    ]
  )
  
  t.deepEqual(
    split(
      double('Lorem ipsum. Dolor sit amet, consectetur adipiscing elitx nulla tristique nunc quis blandit ultriciesx nullam ante risus. Vehicula at arcu eleifend, tempus condimentum lectus proin lacinia dolor elit, nec laoreet magna ultrices vel maecenas scelerisque tortor massa, non faucibus dui consectetur sed.')
    ),
    [
      double('Lorem ipsum. Dolor sit amet, consectetur adipiscing elitx nulla tristique nunc quis blandit ultriciesx nullam ante risus. Vehicula at arcu…'),
      double('…eleifend, tempus condimentum lectus proin lacinia dolor elit, nec laoreet magna ultrices vel maecenas scelerisque tortor massa, non…'),
      double('…faucibus dui consectetur sed.')
    ]
  )
  
  t.deepEqual(
    split(
      double('Loremxipsumxdolorxsitxametxxconsecteturxadipiscingxelitxxnullaxtristiquexnuncxquisxblanditxultriciesxxnullamxantexrisusxxvehiculaxatxarcuxeleifendxxtempusxcondimentumxlectusx')
    ),
    [
      double('Loremxipsumxdolorxsitxametxxconsecteturxadipiscingxelitxxnullaxtristiquexnuncxquisxblanditxultriciesxxnullamxantexrisusxxvehiculaxatxarcuxe…'),
      double('…leifendxxtempusxcondimentumxlectusx')
    ]
  )
})
